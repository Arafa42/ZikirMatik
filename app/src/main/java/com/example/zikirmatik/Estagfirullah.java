...
public class Estagfirullah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tellerKnopPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences = getSharedPreferences("myKey4",MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("teller",tellerText.getText().toString().trim());
                editor.apply();
                Intent intent = new Intent(Estagfirullah.this,OzetEstagfirullah.class);
    ...
    public void getObjectFromPreferences(String key) {
        SharedPreferences prefs = getSharedPreferences(key, Context.MODE_PRIVATE);
        teller = prefs.getInt("teller5", MODE_PRIVATE);
