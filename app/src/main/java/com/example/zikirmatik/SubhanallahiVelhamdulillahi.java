    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tellerKnopPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences = getSharedPreferences("myKey11",MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("teller",tellerText.getText().toString().trim());
                editor.apply();
                Intent intent = new Intent(SubhanallahiVelhamdulillahi.this,OzetSubhanallahiVelhamdulillahi.class);
