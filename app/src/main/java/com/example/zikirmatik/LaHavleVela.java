...
public class LaHavleVela extends AppCompatActivity {
    ...
    public void saveData(){
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("saveTeller8",MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt("tellerWaarde8",teller);
        editor.apply();
    }
    ...
    public void LoadData(){
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("saveTeller8",MODE_PRIVATE);
        teller = sharedPreferences.getInt("tellerWaarde8",MODE_PRIVATE);
