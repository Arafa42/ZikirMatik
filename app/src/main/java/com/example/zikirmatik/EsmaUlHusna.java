...
public class EsmaUlHusna extends AppCompatActivity {
    ...
    public void saveData(){
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("saveTeller4",MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt("tellerWaarde4",teller);
        editor.apply();
    }
    ...
    public void LoadData(){
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("saveTeller4",MODE_PRIVATE);
        teller = sharedPreferences.getInt("tellerWaarde4",MODE_PRIVATE);
